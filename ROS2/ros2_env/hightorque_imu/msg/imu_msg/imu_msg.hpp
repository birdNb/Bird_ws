...
#ifndef __imu_msg_imu_msg_hpp__
#define __imu_msg_imu_msg_hpp__
...
int imu_msg::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_msg::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int imu_msg::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t imu_msg::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* imu_msg::getTypeName()
{
    return "imu_msg";
}

int imu_msg::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->magnet[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
int imu_msg::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->magnet[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
int imu_msg::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t imu_msg::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xbf2ac729a1ff4c8dLL;
