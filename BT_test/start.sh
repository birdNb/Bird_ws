...
chmod +x ble_gatt_server.py ble_ros_bridge.py ble_neck_bridge.py ble_locate_face_manager.py ble_hand_identify_manager.py ble_command_dispatcher.py ble_status_telemetry.py ble_log.py run_ble_with_ros.sh ros_env.sh
